...
complete -c eopkg -n '__fish_seen_subcommand_from remove-repo rr enable-repo er disable-repo dr list-available la' -a "(__fish_eopkg_print_repos)" -d "Repository"
complete -c eopkg -n '__fish_seen_subcommand_from upgrade up install it info' -a "(__fish_print_packages)" -d "Available Package"
complete -c eopkg -n '__fish_seen_subcommand_from remove rm autoremove rmf check' -a "(__fish_print_packages --installed)" -d "Installed Package"
complete -c eopkg -n '__fish_seen_subcommand_from upgrade up remove rm install it info check list-available la list-installed li list-upgrades lu' -s c -l component -a "(__fish_eopkg_print_components)" -d "Component"
...
## Install
__fish_eopkg_subcommand_with_shortcut install it -r -d "Install packages"
...
## Remove
__fish_eopkg_subcommand_with_shortcut remove rm -x -d "Remove packages"
...
## Autoremove
__fish_eopkg_subcommand_with_shortcut autoremove rmf -x -d "Remove packages and dependencies"
...
__fish_eopkg_option_with_shortcut search sr -l description -d "Search in package's description"
__fish_eopkg_option_with_shortcut search sr -l name -d "Search in package's name"
__fish_eopkg_option_with_shortcut search sr -l summary -d "Search in package's summary"
...
## Repo Management
__fish_eopkg_subcommand_with_shortcut add-repo ar -x -d "Add a repository"
...
## Info
__fish_eopkg_subcommand info -x -d "Display package information"
__fish_eopkg_option info -l xml -d "Output in xml format"
__fish_eopkg_option info -s c -l component -x -d "Info about given component"
